...
__export(src_exports, {
    ...
    DEFAULT_CHAIN: function() {
        return DEFAULT_CHAIN;
    },
    DEFAULT_SYMBOL: function() {
        return DEFAULT_SYMBOL;
    },
    DEFAULT_SYSTEM_DOMAIN: function() {
        return DEFAULT_SYSTEM_DOMAIN;
    },
    EOSAUTH: function() {
        return EOSAUTH;
    },
    ...
    LEDGER_WEBHID: function() {
        return LEDGER_WEBHID;
    },
    LEDGER_WEBUSB: function() {
        return LEDGER_WEBUSB;
    },
    LYNX: function() {
        return LYNX;
    },
    ...
    SCATTER_DESKTOP: function() {
        return SCATTER_DESKTOP;
    },
    SCATTER_DESKTOP_MANUAL: function() {
        return SCATTER_DESKTOP_MANUAL;
    },
    SCATTER_EXTENSION: function() {
        return SCATTER_EXTENSION;
    },
    SIMPLEOS: function() {
        return SIMPLEOS;
    },
    ...
    WAX_CLOUD_WALLET: function() {
        return WAX_CLOUD_WALLET;
    },
    WOMBAT: function() {
        return WOMBAT;
    },
    ...
    chainToNetworkConstantsMap: function() {
        return chainToNetworkConstantsMap;
    },
    constants: function() {
        return constants13;
    },
    ...
    getContractConstants: function() {
        return getContractConstants;
    },
    historyTypesFeatures: function() {
        return historyTypesFeatures;
    }
});
...
// src/contract.ts
var getContractConstants = function() {
    var chain = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : DEFAULT_CHAIN, systemDomain = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : DEFAULT_SYSTEM_DOMAIN;
    var proxyInfo;
    if ([
        "eos",
        "bos",
    ...
    return {
        ...
        EOSIO_TOKEN: ![
            "fio",
            "fio-test"
        ].includes(chain) ? "".concat(systemDomain, ".token") : "fio.token",
        ACCOUNT_INFO: "account.info",
        PROXY_INFO_ACCOUNT: proxyInfo,
        EOSIO_MSIG: "".concat(systemDomain, ".msig"),
        EOSIO_RAM: "".concat(systemDomain, ".ram"),
        EOSIO_STAKE: "".concat(systemDomain, ".stake"),
        EOSIO_PRODS: "".concat(systemDomain, ".prods"),
        EOSIO_NULL: "".concat(systemDomain, ".null"),
        EOSIO_RAMFEE: "".concat(systemDomain, ".ramfee"),
        EOSIO_VPAY: "".concat(systemDomain, ".vpay"),
        EOSIO_BPAY: "".concat(systemDomain, ".bpay"),
        EOSIO_REX: "".concat(systemDomain, ".rex"),
        // Params
...
var dapps = [
    ...
    },
    {
        ...
        logo: "https://explorer.xprnetwork.org/img/dapps/prospectors.png",
    ...
    },
    {
        ...
        logo: "https://explorer.xprnetwork.org/img/dapps/cryptosnm.png",
    ...
    },
    {
        ...
        logo: "https://explorer.xprnetwork.org/img/dapps/murmur.png",
    ...
    },
    {
        ...
        logo: "https://explorer.xprnetwork.org/img/dapps/emanate.png",
    ...
    },
    {
        ...
        app: "https://pixeos.io",
        logo: "https://explorer.xprnetwork.org/img/dapps/pixeos.png",
    ...
    },
    {
        ...
        logo: "https://explorer.xprnetwork.org/img/dapps/everipedia.jpg",
        website: "",
    ...
    },
    {
        ...
        logo: "https://explorer.xprnetwork.org/img/dapps/deosgames.png",
    ...
    },
    {
        ...
        logo: "https://explorer.xprnetwork.org/img/dapps/chintai.png",
    ...
    },
    {
        ...
        logo: "https://explorer.xprnetwork.org/img/dapps/newdex.png",
    ...
    },
    {
        ...
        logo: "https://explorer.xprnetwork.org/img/dapps/eosnameswaps.png",
...
var exchanges = {
    ...
    Newdex: {
        ...
        website: "https://newdex.io/",
        linkGenerator: function(token, pair) {
            return "https://newdex.io/trade/".concat(token.account, "-").concat(pair.pair_base.toLowerCase(), "-").concat(pair.pair_quote.toLowerCase());
        }
    },
    DefiBox: {
        name: "DefiBox",
        ...
        linkGenerator: function(_, __) {
            return "https://defibox.io/";
        }
    },
    PayCash: {
        name: "PayCash Swap",
        description: "Top Swap on EOS",
        accounts: [
            "swap.pcash"
        ],
        logo: "https://raw.githubusercontent.com/eoscafe/eos-dapps/master/logos/paycash.png",
        website: "https://paycashswap.com/",
        linkGenerator: function(_, __) {
            return "https://paycashswap.com/";
        }
    },
    Chaince: {
        name: "Chaince",
        ...
        linkGenerator: function(_, pair) {
            return "https://chaince.com/trade/".concat(pair.pair_base.toLowerCase()).concat(pair.pair_quote.toLowerCase());
        }
    },
    Dexeos: {
        name: "Dexeos",
        ...
        linkGenerator: function(_, pair) {
            return "https://dexeos.io/trade/".concat(pair.pair_base.toUpperCase());
        }
    },
    Hoo: {
        name: "Hoo",
        ...
        linkGenerator: function(_, pair) {
            return "https://hoo.com/trade/".concat(pair.pair_base.toLowerCase(), "-").concat(pair.pair_quote.toLowerCase());
        }
    },
    Whaleex: {
        name: "Whaleex",
        ...
        linkGenerator: function(_, pair) {
            return "https://www.whaleex.com/trade/".concat(pair.pair_base, "_").concat(pair.pair_quote);
        }
    },
    Chainrift: {
        name: "Chainrift",
        ...
        linkGenerator: function(_, pair) {
            return "https://www.chainrift.com/trading?coinpair=".concat(pair.pair_base, "/").concat(pair.pair_quote);
        }
    },
    Eosdaq: {
        name: "EOSDAQ",
        ...
        linkGenerator: function(_, pair) {
            return "https://eosdaq.com/exchange/".concat(pair.pair_base, "_").concat(pair.pair_quote);
        }
    },
    BigONE: {
        name: "BigONE",
        ...
        linkGenerator: function(_, pair) {
            return "https://big.one/trade/".concat(pair.pair_base, "-").concat(pair.pair_quote);
        }
    },
    YOLO: {
        name: "YOLO",
        ...
        linkGenerator: function(_, pair) {
            return "https://yoloswap.com/swap/".concat(pair.pair_quote.toLowerCase(), "-").concat(pair.pair_base.toLowerCase());
        }
    },
    Bancor: {
        name: "Bancor",
        ...
        linkGenerator: function(_, pair) {
            return "https://www.bancor.network/token/".concat(pair.pair_base);
        }
    },
    Alcor: {
        name: "Alcor",
...
//   testnet: true
// },
_define_property(_obj, "fio-test", {
    key: "fio-test",
    text: "FIO Testnet",
...
// src/common.ts
var getCommonConstants = function(chain) {
    return {
...
// src/utils.ts
var generateProviderEndpoints = function(chainId, actionEndpoints) {
    return [
        {
            chainId: chainId,
            port: 443,
...
var CHAIN_START_DATE2 = /* @__PURE__ */ new Date("2019-06-24");
...
var ATOMICASSETS_API3 = "https://aa-xprnetwork-main.saltant.io";
var CHAIN3 = "proton";
var CHAIN_ID3 = "384da888112027f0321850a169f737c33e53b388aad48b5adace4bab97f437e0";
var CHAIN_START_DATE3 = /* @__PURE__ */ new Date("Apr 22, 2020");
...
var HYPERION_URL3 = "https://hyp-xpr.api.mainnet.metalx.com";
var KEY_PREFIX3 = "EOS";
var LIGHT_API3 = "https://lightapi-xpr.api.mainnet.metalx.com";
var MAX_VOTES = 4;
...
var CHAIN_START_DATE4 = /* @__PURE__ */ new Date("Mar 24, 2020");
...
var CHAIN_START_DATE6 = /* @__PURE__ */ new Date("Nov 23, 2018");
...
var CHAIN_START_DATE7 = /* @__PURE__ */ new Date("Feb 19, 2020");
...
var CHAIN_START_DATE8 = /* @__PURE__ */ new Date("Jul 10, 2018");
...
var CHAIN_START_DATE9 = /* @__PURE__ */ new Date("2020-01-14");
...
var ATOMICASSETS_API4 = "https://aa-xprnetwork-test.saltant.io";
var CHAIN10 = "proton-test";
var CHAIN_ID10 = "71ee83bcf52142d61019d95f9cc5427ba6a0d7ff8accd9e2088ae2abeaf3d3dd";
var CHAIN_START_DATE10 = /* @__PURE__ */ new Date("April 3, 2020");
...
var HYPERION_URL8 = "https://hyp-xprtest.api.testnet.metalx.com";
var KEY_PREFIX10 = "EOS";
var MAX_VOTES2 = 4;
var LIGHT_API5 = "https://lightapi-xprtest.api.testnet.metalx.com";
...
var CHAIN_START_DATE11 = /* @__PURE__ */ new Date("Dec 5, 2019");
...
var DEFAULT_ENDPOINTS12 = [
    "https://fio-api-testnet.eosiomadrid.io",
    "https://test.fio.eosusa.io",
    "https://fio-testnet.genereos.io"
];
...
var CHAIN_START_DATE12 = /* @__PURE__ */ new Date("Mar 10, 2020");
...
var _obj1;
// src/index.ts
var chainToNetworkConstantsMap = (_obj1 = {
    eos: eos_default,
    wax: wax_default,
    ...
    kylin: kylin_default,
    fio: fio_default
}, _define_property(_obj1, "eos-test", eos_test_default), _define_property(_obj1, "proton-test", proton_test_default), _define_property(_obj1, "wax-test", wax_test_default), _define_property(_obj1, "fio-test", fio_test_default), _obj1);
var Constants = /*#__PURE__*/ function() {
    function _Constants() {
        _class_call_check(this, _Constants);
        if (!!_Constants.instance) {
            return _Constants.instance;
        }
    }
    _create_class(_Constants, [
        {
            key: "initialize",
            value: function initialize(chain) {
        ...
        {
            key: "setNetwork",
            value: function setNetwork(chain) {
        ...
        {
            key: "setCommon",
            value: function setCommon(chain) {
        ...
        {
            key: "setContract",
            value: function setContract(chain) {
                var systemDomain = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : DEFAULT_SYSTEM_DOMAIN;
        ...
        {
            key: "setConstants",
            value: function setConstants(newConstants) {
                var _iteratorNormalCompletion = true, _didIteratorError = false, _iteratorError = undefined;
                try {
                    for(var _iterator = Object.entries(newConstants)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
